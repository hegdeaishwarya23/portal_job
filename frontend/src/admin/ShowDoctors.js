...
export default class ShowCompany extends Component {
  ...
  onDeleteUser = async (id, e) => {
    ...
    try {
      await axios.delete(`http://localhost:5000/api/v1/companies/${id}`, config);
          ...
          <div id="portfolio">
            <div className="container showtop  login-second ">
              <div className="page-title text-center">
                <h1 className="text-dark">LIST OF COMPANIES</h1>
